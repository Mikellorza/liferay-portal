...
@JsonSubTypes(
	{
		@JsonSubTypes.Type(
			...
			value = SitePageNavigationSettings.class
		),
		@JsonSubTypes.Type(
			name = "WidgetTemplateNavigationSettings",
...
public abstract class NavigationSettings implements Serializable {
	...
	public static enum NavigationSettingsType {
		...
		SITE_PAGE_NAVIGATION_SETTINGS("SitePageNavigationSettings"),
		WIDGET_PAGE_TEMPLATE_NAVIGATION_SETTINGS(
