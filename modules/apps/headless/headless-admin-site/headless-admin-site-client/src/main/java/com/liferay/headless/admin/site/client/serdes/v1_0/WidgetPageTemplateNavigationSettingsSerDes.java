...
public class WidgetPageTemplateNavigationSettingsSerDes {
	...
	public static String toJSON(
		...
		if (widgetPageTemplateNavigationSettings.getTest1() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(_escape(widgetPageTemplateNavigationSettings.getTest1()));
	...
	public static Map<String, String> toMap(
		...
		if (widgetPageTemplateNavigationSettings.getTest1() == null) {
			...
			map.put(
				"test1",
				String.valueOf(
					widgetPageTemplateNavigationSettings.getTest1()));
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "test1")) {
				if (jsonParserFieldValue != null) {
					widgetPageTemplateNavigationSettings.setTest1(
