...
public class SitePageNavigationSettingsSerDes {
	...
	public static String toJSON(
		...
		if (sitePageNavigationSettings.getTest1() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(_escape(sitePageNavigationSettings.getTest1()));
	...
	public static Map<String, String> toMap(
		...
		if (sitePageNavigationSettings.getTest1() == null) {
			...
			map.put(
				"test1", String.valueOf(sitePageNavigationSettings.getTest1()));
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "test1")) {
				if (jsonParserFieldValue != null) {
					sitePageNavigationSettings.setTest1(
