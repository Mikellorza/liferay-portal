...
public abstract class BaseSimilarAssetGroupResourceImpl
	implements SimilarAssetGroupResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-cms/v1.0/similar-asset-groups'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "SimilarAssetGroup")
		}
	)
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/similar-asset-groups")
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseSimilarAssetGroupResourceImpl.class);

}
// LIFERAY-REST-BUILDER-HASH:92532725