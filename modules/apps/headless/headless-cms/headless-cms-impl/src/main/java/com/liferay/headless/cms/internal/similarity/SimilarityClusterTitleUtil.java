...
public class SimilarityClusterTitleUtil {
	...
	// The list is English only. A cluster name is cosmetic and never decides
	// what groups with what, so the cost is a longer name in every other
	// language rather than a wrong cluster
