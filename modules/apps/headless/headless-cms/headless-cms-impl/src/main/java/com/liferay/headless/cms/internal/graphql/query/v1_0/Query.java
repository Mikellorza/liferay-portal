...
public class Query {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {similarityClusters(assetLibraryId: ___, dimension: ___, page: ___, pageSize: ___, search: ___, sorts: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField(
			...
			similarityClusterResource -> new SimilarityClusterPage(
				similarityClusterResource.getSimilarityClustersPage(
					...
					_sortsBiFunction.apply(
						similarityClusterResource, sortsString))));
	}
...
// LIFERAY-REST-BUILDER-HASH:2065030028