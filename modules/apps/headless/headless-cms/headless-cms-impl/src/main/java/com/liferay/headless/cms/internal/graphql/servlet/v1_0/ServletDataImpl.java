...
import com.liferay.headless.cms.internal.resource.v1_0.SimilarAssetGroupResourceImpl;
...
public class ServletDataImpl implements ServletData {
	...
	public void activate(BundleContext bundleContext) {
		...
		Query.setSimilarAssetGroupResourceComponentServiceObjects(
			...
			new HashMap<String, ObjectValuePair<Class<?>, String>>() {
				{
					...
					put(
						"query#similarAssetGroups",
						new ObjectValuePair<>(
							SimilarAssetGroupResourceImpl.class,
							"getSimilarAssetGroupsPage"));
				}
			};
...
// LIFERAY-REST-BUILDER-HASH:-1292353404