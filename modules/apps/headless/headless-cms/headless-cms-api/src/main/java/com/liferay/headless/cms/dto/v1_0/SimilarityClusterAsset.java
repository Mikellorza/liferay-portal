...
public class SimilarityClusterAsset implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The URL of the asset's edit form, the same one the CMS listings link their edit action to. Absent when the user cannot update the asset, so that the listing hides the action. Append your own redirect parameter."
	)
...
// LIFERAY-REST-BUILDER-HASH:864193017