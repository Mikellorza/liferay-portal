...
public class SimilarityClusterResult implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The total number of clustered assets that match the search, independent of the requested page. Backs both the card's count and the listing's entry count."
	)
...
// LIFERAY-REST-BUILDER-HASH:144882492