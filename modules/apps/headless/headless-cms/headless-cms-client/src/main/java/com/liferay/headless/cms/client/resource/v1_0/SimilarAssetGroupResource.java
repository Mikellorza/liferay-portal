 ...
 */
@Generated("")
public interface SimilarAssetGroupResource {
	...
	public HttpInvoker.HttpResponse getSimilarAssetGroupsPageHttpResponse(
			Long assetLibraryId, Pagination pagination)
		throws Exception;
	...
	public static class Builder {
		...
		public SimilarAssetGroupResource build() {
			return new SimilarAssetGroupResourceImpl(this);
		}
	...
	public static class SimilarAssetGroupResourceImpl
		implements SimilarAssetGroupResource {
		...
		public Page<SimilarAssetGroup> getSimilarAssetGroupsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getSimilarAssetGroupsPageHttpResponse(
			...
			try {
				return Page.of(content, SimilarAssetGroupSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-cms/v1.0/similar-asset-groups");
		...
		private SimilarAssetGroupResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			SimilarAssetGroupResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:-715117071