...
public class CopyLayoutMVCActionCommandTest {
	...
	public void testDoProcessActionCopyLayoutWithPermissions()
		...
		Role role = _roleLocalService.addRole(
			_serviceContext.getUserId(), null, 0, "Test role",
			Collections.singletonMap(_serviceContext.getLocale(), "Test role"),
		...
		modelPermissions.addRolePermissions("Test role", ActionKeys.VIEW);
