...
public class SegmentsExperiencePersistenceTest {
	...
	@Test
	public void testCountBySERC_SSERC() throws Exception {
		_persistence.countBySERC_SSERC("", "");

		_persistence.countBySERC_SSERC("null", "null");

		_persistence.countBySERC_SSERC((String)null, (String)null);
	}

	@Test
	public void testCountByG_SERC_SSERC() throws Exception {
		_persistence.countByG_SERC_SSERC(RandomTestUtil.nextLong(), "", "");

		_persistence.countByG_SERC_SSERC(0L, "null", "null");

		_persistence.countByG_SERC_SSERC(0L, (String)null, (String)null);
	}
	...
	@Test
	public void testCountByG_SERC_SSERC_P() throws Exception {
		_persistence.countByG_SERC_SSERC_P(
			RandomTestUtil.nextLong(), "", "", RandomTestUtil.nextLong());

		_persistence.countByG_SERC_SSERC_P(0L, "null", "null", 0L);

		_persistence.countByG_SERC_SSERC_P(0L, (String)null, (String)null, 0L);
	}

	@Test
	public void testCountByG_SERC_SSERC_P_A() throws Exception {
		_persistence.countByG_SERC_SSERC_P_A(
			RandomTestUtil.nextLong(), "", "", RandomTestUtil.nextLong(),
			RandomTestUtil.randomBoolean());
	...
	@Test
	public void testCountByG_SERC_SSERC_P_AArrayable() throws Exception {
		_persistence.countByG_SERC_SSERC_P_A(
