...
public class ObjectEntryResourceTest {
	...
	public void testGetObjectEntriesSystemProperties() throws Exception {
		...
		JSONObject objectDefinitionObjectEntryJSONObject =
			itemsJSONArray.getJSONObject(0);

		Assert.assertNull(
			objectDefinitionObjectEntryJSONObject.getJSONObject(
				"systemProperties"));
		...
		objectDefinitionObjectEntryJSONObject = itemsJSONArray.getJSONObject(0);
